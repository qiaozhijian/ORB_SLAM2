 ...
 * 2. Edge:
 *     - g2o::EdgeSE3ProjectXYZOnlyPose()，BaseUnaryEdge // for Monocular
 *         + Vertex：待优化当前帧的Tcw
 *         + measurement：MapPoint在当前帧中的二维位置(u,v)
 *         + InfoMatrix: invSigma2(与特征点所在的尺度有关)
 *     - g2o::EdgeStereoSE3ProjectXYZOnlyPose()，BaseUnaryEdge // for Stereo
 *         + Vertex：待优化当前帧的Tcw
...
//    每次迭代实词
        ...
        for (size_t it = 0; it < 4; it++) {
            ...
            //每次循环都清零，所以只加不减,最后会返回最后一次ransac的外点数
            nBad = 0;
            //找外点
