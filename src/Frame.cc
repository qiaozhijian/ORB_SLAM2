     ...
     mvLevelSigma2(frame.mvLevelSigma2), mvInvLevelSigma2(frame.mvInvLevelSigma2)
{
    ...
    Frame::Frame(long unsigned int realNi, const cv::Mat &imLeft, const cv::Mat &imRight, const double &timeStamp, ORBextractor *extractorLeft,
                 ...
                 const float &thDepth)
            : is_keyframe(false),mpORBvocabulary(voc), mpORBextractorLeft(extractorLeft), mpORBextractorRight(extractorRight),
    ...
    Frame::Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp, ORBextractor *extractor,
            ...
            : is_keyframe(false),mpORBvocabulary(voc), mpORBextractorLeft(extractor),
